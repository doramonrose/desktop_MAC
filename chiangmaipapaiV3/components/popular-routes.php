  ...
  <div class="container-page">
    ...
    <div class="route-grid">
      <?php foreach ($routes as $route): ?>
        <a class="route-card" href="<?= e($route['url']) ?>" data-analytics="select_route" data-route="<?= e($route['id']) ?>">
          ...
          <div class="route-card-body">
            ...
            <p class="price-inline"><?= e(price_label('destinations', $route['price_id'], $prices)) ?></p>
          </div>
        </a>
      <?php endforeach; ?>
    </div>
