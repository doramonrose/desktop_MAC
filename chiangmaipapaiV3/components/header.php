...
<header class="site-header">
  <div class="container-page header-inner">
    ...
    <div class="header-actions">
      ...
      <?php if ($lineReady): ?>
        <a class="btn-line header-line" href="<?= e($business['line_url']) ?>" data-analytics="click_line" data-button-position="header" target="_blank" rel="noopener noreferrer">LINE <?= e($business['line_id']) ?></a>
      <?php endif; ?>
...
<aside class="drawer" id="mobile-drawer" aria-hidden="true" aria-label="เมนูมือถือ">
  ...
  <?php if ($lineReady): ?>
    <a class="btn-line w-full" href="<?= e($business['line_url']) ?>" data-analytics="click_line" data-button-position="drawer" target="_blank" rel="noopener noreferrer">คุยผ่าน LINE <?= e($business['line_id']) ?></a>
  <?php endif; ?>
</aside>
