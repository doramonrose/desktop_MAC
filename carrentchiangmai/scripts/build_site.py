...
VEHICLES = [
    ("รถเก๋ง City Car", "1–3 ท่าน", "สอบถามตามขนาดกระเป๋า", "1,000 บาท/วัน", "/chiang-mai-sedan-with-driver/"),
    ("รถเก๋งขนาดเล็ก", "ไม่เกิน 4 ท่าน", "สอบถามตามขนาดกระเป๋า", "1,200 บาท/วัน", "/chiang-mai-sedan-with-driver/"),
    ("รถเก๋งขนาดกลาง", "ไม่เกิน 4 ท่าน", "สอบถามตามขนาดกระเป๋า", "1,300 บาท/วัน", "/chiang-mai-sedan-with-driver/"),
    ("รถ SUV", "ไม่เกิน 6 ท่าน", "จำนวนกระเป๋าขึ้นกับผู้โดยสาร", "1,500 บาท/วัน", "/chiang-mai-suv-with-driver/"),
    ("รถตู้ VIP", "ไม่เกิน 10 ท่าน", "แจ้งจำนวนและขนาดก่อนจอง", "1,600 บาท/วัน", "/chiang-mai-van-with-driver/"),
    ("รถผู้บริหาร", "ยืนยันตามรุ่นรถ", "ยืนยันตามรุ่นรถ", "5,000 บาท/วัน", "/chiang-mai-executive-car/"),
]
...
PAGES = {
    "/car-with-driver-chiang-mai/": {
        "title": "รถเช่าพร้อมคนขับเชียงใหม่ เลือกรถตามจำนวนคน | Car Rent Chiang Mai",
...
for path, (h1, intro, price, route) in TOUR_DETAILS.items():
    ...
    page_title = f"{h1} | Car Rent Chiang Mai"
...
:root{--ink:#132033;--navy:#16345a;--navy-deep:#0a1830;--gold:#c8963e;--amber:#a9782d;--cream:#f4efe6;--sand:#ebe4d7;--paper:#fffdf9;--muted:#5c6a79;--line:#e4ddd0;--line-dark:#c9c0b0;--ok:#1f6b4a;--line-green:#14845a;--radius:28px;--shadow:0 28px 70px rgba(10,24,48,.16);--max:1200px}
*{box-sizing:border-box}html{scroll-behavior:smooth;max-width:100%;overflow-x:hidden}body{margin:0;max-width:100%;overflow-x:hidden;color:var(--ink);background:var(--paper);font-family:"Kanit",Tahoma,sans-serif;line-height:1.65}body.nav-open{overflow:hidden}
...
.nav-wrap{min-height:78px;display:flex;align-items:center;gap:1.1rem;min-width:0}.brand{display:flex;align-items:center;gap:.7rem;min-width:0;text-decoration:none;font-weight:700;line-height:1.15;color:var(--ink)}.brand-mark{display:grid;place-items:center;flex:0 0 44px;width:44px;height:44px;border-radius:50%;background:linear-gradient(145deg,#1a3d68,#0d2342);color:#fff;font-size:1rem;letter-spacing:.04em;box-shadow:0 10px 24px rgba(13,35,66,.25)}.brand small{display:block;color:var(--muted);font-weight:400}
.nav-toggle{display:none;flex:0 0 auto;margin-left:auto;background:#fff;border:1px solid var(--line-dark);border-radius:999px;padding:.55rem .9rem}.site-nav{margin-left:auto;display:flex;align-items:center;gap:1.05rem}.site-nav a{text-decoration:none;font-weight:500;color:var(--ink)}.site-nav a:not(.btn):hover{color:var(--gold)}.site-nav .btn{color:#fff}
.btn{display:inline-flex;align-items:center;justify-content:center;gap:.45rem;min-height:48px;padding:.72rem 1.25rem;border:1.5px solid transparent;border-radius:999px;background:var(--gold);color:#fff;text-decoration:none;font-weight:600;cursor:pointer;transition:transform .2s ease,box-shadow .2s ease,background .2s ease}.btn:hover{background:#a67828;color:#fff;transform:translateY(-1px);box-shadow:0 12px 28px rgba(168,120,40,.28)}.btn-secondary{background:rgba(255,255,255,.12);border-color:rgba(255,255,255,.55);color:#fff;backdrop-filter:blur(8px)}.btn-secondary:hover{background:#fff;color:var(--navy-deep)}.btn-line{background:var(--line-green)}.btn-line:hover{background:#0f6847}.btn-ghost{background:#fff;border-color:rgba(19,32,51,.14);color:var(--navy)}.btn-ghost:hover{background:var(--navy);color:#fff}.btn-small{min-height:42px;padding:.5rem .95rem;font-size:.92rem}.text-link{font-weight:600;text-decoration:none}.text-link:hover{text-decoration:underline}
.eyebrow{display:inline-flex;align-items:center;gap:.55rem;text-transform:uppercase;letter-spacing:.14em;font-weight:600;color:#8a6420;font-size:.74rem}.eyebrow:before{content:"";width:28px;height:1px;background:currentColor;opacity:.7}
...
.hero .eyebrow{color:#f0d59a}.hero h1{font-size:clamp(2.55rem,5.4vw,4.8rem);line-height:1.05;letter-spacing:-.04em;margin:.85rem 0 1.2rem;max-width:12ch;text-wrap:balance}.hero-lead{font-size:clamp(1.02rem,1.7vw,1.2rem);color:rgba(255,255,255,.88);max-width:36rem;margin:0}.hero-actions{display:flex;flex-wrap:wrap;gap:.75rem;margin:1.7rem 0 1rem}.microcopy{font-size:.9rem;color:rgba(255,255,255,.72);margin:0}
.price-panel{background:rgba(255,253,249,.94);color:var(--ink);border-radius:24px;padding:1.35rem 1.4rem;box-shadow:var(--shadow);backdrop-filter:blur(14px);border:1px solid rgba(255,255,255,.55)}.price-panel .eyebrow{color:#8a6420}.price-panel .eyebrow:before{display:none}.price-panel strong{display:block;font-size:clamp(1.4rem,2.5vw,1.9rem);color:var(--navy);margin-top:.35rem}.check-list{list-style:none;padding:0;margin:.85rem 0 1rem}.check-list li{padding:.3rem 0 .3rem 1.45rem;position:relative;font-size:.92rem;color:var(--muted)}.check-list li:before{content:"✓";position:absolute;left:0;color:var(--ok);font-weight:700}
.trust-strip{background:#fff;border-bottom:1px solid var(--line)}.trust-grid{display:grid;grid-template-columns:repeat(4,1fr)}.trust-item{padding:1.4rem 1rem;text-align:center;font-weight:600;border-right:1px solid var(--line)}.trust-item:last-child{border-right:0}.trust-item span{display:block;margin-top:.25rem;font-size:.8rem;color:var(--muted);font-weight:400}
section{padding:clamp(4.2rem,8vw,7.2rem) 0}.section-soft{background:linear-gradient(180deg,#f7f2e9,#f3eee4)}.section-head{display:flex;justify-content:space-between;gap:2rem;align-items:end;margin-bottom:2.4rem}.section-head h2{font-size:clamp(2rem,3.7vw,3.25rem);line-height:1.12;letter-spacing:-.03em;margin:.4rem 0 0;max-width:14ch}.section-head p{max-width:34rem;color:var(--muted);margin:0}
...
.card{background:#fff;border:1px solid rgba(19,32,51,.06);border-radius:var(--radius);padding:1.45rem;box-shadow:0 14px 36px rgba(10,24,48,.06);transition:transform .25s ease,box-shadow .25s ease}.card:hover{transform:translateY(-4px);box-shadow:0 22px 48px rgba(10,24,48,.12)}.card h3{margin:.35rem 0 .45rem;font-size:1.28rem;line-height:1.28}.card p{color:var(--muted);margin:.2rem 0}.card .price{color:var(--navy);font-size:1.18rem;font-weight:700}.card-footer{display:flex;justify-content:space-between;gap:.75rem;align-items:center;margin-top:1.1rem;padding-top:1rem;border-top:1px solid var(--line)}.badge{display:inline-flex;border-radius:999px;background:#eef3f8;color:var(--navy);padding:.3rem .7rem;font-size:.74rem;font-weight:600}
.vehicle-card{position:relative;overflow:hidden;background:linear-gradient(180deg,#fff,#fbf8f2)}.vehicle-card:before{content:"";position:absolute;inset:auto -20% -40% auto;width:160px;height:160px;border-radius:50%;background:radial-gradient(circle,rgba(200,150,62,.16),transparent 68%)}.vehicle-index{position:absolute;top:1.15rem;right:1.25rem;color:#8b97a8;font-size:2.15rem;font-weight:700;line-height:1}
.tour-mosaic{display:grid;grid-template-columns:1.35fr 1fr 1fr;grid-template-rows:auto auto;gap:1.15rem}.tour-card{position:relative;padding:0;overflow:hidden;min-height:280px;isolation:isolate}.tour-card.featured{grid-row:1 / span 2;min-height:100%}.tour-card img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;transition:transform .55s ease}.tour-card:hover img{transform:scale(1.06)}.tour-card:after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(8,18,34,.05),rgba(8,18,34,.72) 72%);z-index:1}.tour-card-body{position:relative;z-index:2;height:100%;min-height:280px;display:flex;flex-direction:column;justify-content:flex-end;padding:1.35rem;color:#fff}.tour-card.featured .tour-card-body{min-height:560px;padding:1.7rem}.tour-card .badge{background:rgba(255,255,255,.18);color:#fff;backdrop-filter:blur(8px)}.tour-card h2,.tour-card h3{color:#fff;font-size:1.35rem;margin:.55rem 0 .35rem}.tour-card h2 a,.tour-card h3 a{color:inherit;text-decoration:none}.tour-card.featured h2,.tour-card.featured h3{font-size:clamp(1.7rem,2.6vw,2.3rem)}.tour-card p{color:rgba(255,255,255,.82)}.tour-card .price{color:#f4d798;font-size:1.15rem}.tour-card .card-footer{border-top-color:rgba(255,255,255,.18)}.tour-card .text-link,.tour-card .btn-small{color:#fff}.tour-card .btn-small{background:rgba(255,255,255,.14);border-color:rgba(255,255,255,.35)}.tour-card .btn-small:hover{background:#fff;color:var(--navy-deep)}
...
.site-footer{background:linear-gradient(180deg,#12263f,#0a1830);color:#d7e0ea;padding:3.4rem 0 6.2rem}.footer-grid{display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:2rem}.site-footer h2,.site-footer h3{color:#fff}.site-footer a{color:#fff}.site-footer ul{list-style:none;padding:0}.site-footer li{margin:.45rem 0}.legal{border-top:1px solid rgba(255,255,255,.12);margin-top:2rem;padding-top:1.2rem;color:#9aabbc;font-size:.88rem}
...
@media(max-width:620px){.container{width:min(calc(100% - 1.2rem),var(--max))}.brand-text{font-size:.9rem}.grid-2,.grid-3,.facts,.quote-form,.footer-grid,.gallery-strip{grid-template-columns:1fr}.field-full{grid-column:auto}.hero{min-height:auto}.hero-inner{padding:5.2rem 0 2.6rem}.hero h1{font-size:clamp(2.35rem,11vw,3.2rem);max-width:none}.hero-actions{flex-direction:column;align-items:stretch}.hero-actions .btn{width:100%}.price-panel{margin-top:.4rem}.trust-item{padding:1rem .4rem;font-size:.85rem}.section-head{margin-bottom:1.5rem}.tour-card,.tour-card-body{min-height:250px}.mobile-cta{display:flex}.site-footer{padding-bottom:7rem}}
...
<header class="site-header">
  <div class="container nav-wrap">
    <a class="brand" href="/">
      ...
      <span class="brand-text">รถพร้อมคนขับเชียงใหม่<small>Car Rent Chiang Mai</small></span>
    </a>
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-grid">
      <div><h2>Car Rent Chiang Mai</h2><p>รถพร้อมคนขับในเชียงใหม่และภาคเหนือ ตรวจรถว่างและสรุปราคาก่อนชำระมัดจำ</p>
...
<head>
  ...
  <meta property="og:url" content="{url(path)}"><meta property="og:image" content="{DOMAIN}/img/logo_carrent.png">
  <meta property="og:image:alt" content="โลโก้ Car Rent Chiang Mai">
...
def render_home() -> str:
    page = {"title":"รถเช่าพร้อมคนขับเชียงใหม่ ราคาชัดเจน | Car Rent Chiang Mai","description":"รถเช่าพร้อมคนขับเชียงใหม่ รถเก๋ง SUV รถตู้ และรถผู้บริหาร เที่ยว รับส่งสนามบิน และภาคเหนือ เช็กรถว่างและสรุปราคาก่อนจอง","h1":"รถเช่าพร้อมคนขับเชียงใหม่ ราคาชัดเจน เดินทางสบาย","intro":""}
    faqs = [
    ...
    vehicle_cards = "".join(f"""<article class="card vehicle-card"><span class="vehicle-index" aria-hidden="true">{i:02d}</span><span class="badge">{esc(cap)}</span><h3>{esc(name)}</h3><p>{esc(bags)}</p><p class="price">เริ่มต้น {esc(price)}</p><div class="card-footer"><a class="text-link" data-vehicle="{esc(name)}" href="{href}">ดูรายละเอียด</a><a class="btn btn-small btn-line" data-line data-placement="vehicle" href="{LINE_FRIEND}" target="_blank" rel="noopener noreferrer">ขอราคา</a></div></article>""" for i,(name,cap,bags,price,href) in enumerate(VEHICLES,1))
    tour_cards_parts = []
    ...
    rows = "".join(f"<tr><td><a data-vehicle='{esc(name)}' href='{href}'>{esc(name)}</a></td><td>{esc(cap)}</td><td>{esc(bags)}</td><td>เริ่มต้น {esc(price)}</td></tr>" for name,cap,bags,price,href in VEHICLES)
...
<section class="hero" id="home">
  ...
  <div class="hero-inner">
    ...
    <aside class="price-panel" aria-label="ราคาเริ่มต้น">
      ...
      <strong>รถรายวันเริ่ม 1,000 บาท</strong>
      <ul class="check-list">
...
def build() -> None:
    ...
    price_rows="".join(f"<tr><td><a href='{href}'>{esc(name)}</a></td><td>{esc(cap)}</td><td>{esc(bags)}</td><td>เริ่มต้น {esc(price)}</td></tr>" for name,cap,bags,price,href in VEHICLES)
    ...
    not_found={"title":"ไม่พบหน้าที่ต้องการ | Car Rent Chiang Mai","description":"ไม่พบหน้าที่ต้องการ กลับไปดูบริการรถพร้อมคนขับหรือโปรแกรมเที่ยว","h1":"ไม่พบหน้าที่ต้องการ","intro":""}
